<%@ Page Language="C#" AutoEventWireup="true" CodeFile="B00145.aspx.cs" Inherits="_B00145" %>
...
<body>
	...
	<tr><td align="center">
		<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體">修改答案項目</p>
		...
		<tr><td style="text-align:center; width:50pt; background-color:#99CCFF; color:#FFFFFF">最後異動時間</td>
			<td align="left"><asp:Label ID="lb_init_time" runat="server"></asp:Label></td>
		</tr>
		</table>
		<p style="margin:10pt 0pt 0pt 0pt">
			<asp:LinkButton ID="lk_save" runat="server" CssClass="abtn" onclick="lk_save_Click" ToolTip="存檔後即關閉">&nbsp;存檔&nbsp;</asp:LinkButton>&nbsp;&nbsp;
	...
	<asp:Label ID="lb_ti_sid" runat="server" Text="0" Visible="false"></asp:Label>
