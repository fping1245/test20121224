<%@ Page Language="C#" AutoEventWireup="true" CodeFile="B00151.aspx.cs" Inherits="_B00151" %>
...
<body>
	...
	<tr><td align="center">
		<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">新增考生資料</p>
		...
		<p style="margin:10pt 0pt 0pt 0pt">
			...
			<a href="javascript:parent.close_all();" class="abtn">&nbsp;取消新增&nbsp;</a>
		</p>&nbsp;
	</td></tr>
	</table>
	</center>
