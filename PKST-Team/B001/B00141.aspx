<%@ Page Language="C#" AutoEventWireup="true" CodeFile="B00141.aspx.cs" Inherits="_B00141"%>
...
<body>
	...
	<tr><td align="center">
		<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體">新增試題</p>
		<table border="1" cellpadding="4" cellspacing="0" style="width:98%; background-color:#F7F7DE">
		<tr><td style="text-align:center; width:10%; background-color:#99CCFF; color:#FFFFFF">試卷標題</td>
			<td align="left" colspan="3"><asp:Label ID="lb_tp_title" runat="server"></asp:Label></td>
		</tr>
		<tr><td style="text-align:center; width:10%; background-color:#99CCFF; color:#FFFFFF">題號</td>
			<td align="left" style="width:40%"><asp:TextBox ID="tb_tq_sort" runat="server" MaxLength="3" Width="20pt"></asp:TextBox></td>
			<td style="text-align:center; width:10%; background-color:#99CCFF; color:#FFFFFF">試題分數</td>
			<td align="left" style="width:40%"><asp:TextBox ID="tb_tq_score" runat="server" Text="10" MaxLength="3" Width="20pt"></asp:TextBox>&nbsp;分</td>
		</tr>
		...
		<tr><td style="text-align:center; background-color:#99CCFF; color:#FFFFFF">試題文字</td>
			<td align="left" colspan="3"><asp:TextBox ID="tb_tq_desc" Rows="10" TextMode="MultiLine" runat="server" MaxLength="200" Width="556px"></asp:TextBox></td>
		</tr>
		</table>
