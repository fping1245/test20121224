<%@ Page Language="C#" AutoEventWireup="true" CodeFile="B0031.aspx.cs" Inherits="_B0031" %>
...
<body>
	...
	<tr><td align="center">
		...
		<p style="margin:10pt 0pt 0pt 0pt">
			<asp:LinkButton ID="lk_confirm" runat="server" CssClass="abtn" onclick="lk_confirm_Click">&nbsp;確認身份&nbsp;</asp:LinkButton>&nbsp;&nbsp;
