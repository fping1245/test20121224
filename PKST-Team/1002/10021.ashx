<%@ WebHandler Language="C#" Class="_10021" %>
//---------------------------------------------------------------------------- 
//程式功能	圖文驗證模組範例 - 產生圖形
...
public class _10021 : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        gdata = bd_img.GenerateImage(200, 54, context.Session["confirm"].ToString());
