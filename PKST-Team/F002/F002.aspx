<%@ Page Language="C#" AutoEventWireup="true" CodeFile="F002.aspx.cs" Inherits="_F002" %>
...
<script language="javascript" type="text/javascript">
	...
	function mprn(msid)
	{
		...
		update.location.href = "F0021.ashx?sid=" + msid + "&timestamp=" + timestamp;
	}
</script>
</head>
<body>
	...
	<div>
	<center>
	<p class="text18pt" style="margin:10pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">產生 Excel 檔案</p>
	<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">▁▂▃▄▅▆▇&nbsp;以線上考試成績清單為例&nbsp;▇▆▅▄▃▂▁</p>
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="功能" ShowHeader="False">
				<ItemTemplate>
					<a href="javascript:mprn(<%# Eval("tp_sid") %>)" class="abtn" title="產生 Excel 格式的成績單">&nbsp;產生成績單&nbsp;</a>&nbsp;
				</ItemTemplate>
				<HeaderStyle Width="66pt" HorizontalAlign="Center" />
