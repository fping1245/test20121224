<%@ Page Language="C#" AutoEventWireup="true" CodeFile="C001.aspx.cs" Inherits="_C001" %>
...
<script language="javascript" type="text/javascript">
	...
	function madd()
	{
		...
		show_win("C0011.aspx?timestamp=" + timestamp, 680, 400);
	}
</script>
</head>
<body>
	...
	<!-- End -->
	<center>
	<p class="text18pt" style="margin:10pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">留言板(前端)</p>
	...
	<tr align="center" bgcolor="#99CCFF">
		...
		<td class="text9pt" style="width:50pt"><font color="#FFFFFF">新增留言</font></td>
	</tr>
	<tr align="center">
		...
		<td><a href="javascript:madd();" class="abtn">&nbsp;我要留言&nbsp;</a></td>
	</tr>
	</table>
	...
	<asp:ListView ID="lv_Ms_Board" runat="server" DataSourceID="ods_Ms_Board" 
		...
		<LayoutTemplate>
			<table id="tbl_lv" runat="server" border="0" cellpadding="0" cellspacing="6" style="width:98%">
				...
				<tr id="tr_page" runat="server" align="center">
					<td id="td_page" runat="server">
