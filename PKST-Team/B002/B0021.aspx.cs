...
public partial class _B0021 : System.Web.UI.Page
{
		...
		if (mErr == "")
		{
			using (SqlConnection Sql_Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["AppSysConnectionString"].ConnectionString))
			{
				using (SqlCommand Sql_Command = new SqlCommand())
				{
					...
					// 新增考生試卷資料
					SqlString = "Insert Into Ts_User (tp_sid, tu_name, tu_no, tu_ip, is_test) Values (@tp_sid, @tu_name, @tu_no, @tu_ip, 1);";
					...
					mErr = "parent.location.replace(\"B00211.aspx?sid=" + tu_sid + "&tp_sid=" + lb_tp_sid.Text + "&tq_sort=1\")";
				}
			}
