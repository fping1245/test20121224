...
<script language="javascript" type="text/javascript">
	// 修改回應內容	(避免 IE Cache 的作用，後面加上 timestamp 的變數，實際上沒有用到)
	...
	{
		if (confirm("確定要刪除「" + mtitle.replace(/ /g, "") + "(" + mtime + ")」的回應資料?\n"))
		{
...
<body style="word-spacing:normal">
						...
						<td><table border="0" cellpadding="4" cellspacing="0" width="100%">
							<tr><td align="center" style="width:50px; background-color:#FFDD55">
								...
								<td align="right" style="width:80pt; vertical-align:top; font-size:12pt">
									<a href="javascript:medit('<%# Eval("fr_sid") %>', '<%# Eval("ff_sid") %>')" class="abtn">&nbsp;修改&nbsp;</a>&nbsp;
									<a href="javascript:mdel('<%# Eval("fr_sid") %>', '<%# Eval("ff_sid") %>','<%# Eval("fr_name") %>','<%# Eval("fr_time") %>')" class="abtn">&nbsp;刪除&nbsp;</a>
								</td>
							</tr>
							</table>
						</td>
	...
	<p style="text-align:center; margin:10pt 0pt 0pt 0pt; font-size:18pt"><a href="D002.aspx<%=lb_page.Text%>" class="abtn">&nbsp;回論壇首頁&nbsp;</a></p>&nbsp;
