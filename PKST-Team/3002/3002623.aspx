<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3002623.aspx.cs" Inherits="_3002623" %>
...
<body>
	...
	<tr><td align="center">
			<p style="margin:10px 0px 5px 0px; font-size:11pt; font-weight:bold; color:Red">相片刪除確認</p>
			...
			<asp:Button ID="bn_ok" runat="server" Height="22pt" Text="確定" ToolTip="按下確定之後，檔案就不見了，請三思喔！" onclick="bn_ok_Click" />&nbsp;
	...
	<asp:Label ID="lb_rownum" runat="server" Text="" Visible="false"></asp:Label>
