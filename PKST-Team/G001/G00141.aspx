<%@ Page Language="C#" AutoEventWireup="true" CodeFile="G00141.aspx.cs" Inherits="_G00141" %>
...
<body>
	...
	<tr><td align="center">
			<p style="text-align:center; font-size:14pt; margin:10pt 0pt 10pt 0pt">新增資料表格</p>
			...
			<tr><td align="center" style="width:12%; background-color:#99CCFF; color:#FFFFFF"">表格名稱</td>
				...
				<td align="left" style="width:38%"><asp:TextBox ID="tb_dt_sort" runat="server" Width="30pt" MaxLength="4" Text="3275"></asp:TextBox>&nbsp;(請輸入 1 ~ 3275 的數字)</td>
			</tr>
