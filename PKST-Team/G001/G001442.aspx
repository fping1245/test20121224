<%@ Page Language="C#" AutoEventWireup="true" CodeFile="G001442.aspx.cs" Inherits="_G001442" %>
...
<body>
	...
	<tr><td align="center">
			<p style="text-align:center; font-size:14pt; margin:10pt 0pt 10pt 0pt">修改表格欄位</p>
			...
			<tr><td align="center" style="width:12%; background-color:#99CCFF; color:#FFFFFF"">欄位順序</td>
				<td align="left" style="width:38%"><asp:Label ID="lb_dr_sort" runat="server"></asp:Label></td>
