...
public partial class _A0041 : System.Web.UI.Page
{
	...
	private void GetData()
	{
		...
		using (SqlConnection Sql_Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["AppSysConnectionString"].ConnectionString))
		{
			using (SqlCommand Sql_Command = new SqlCommand())
			{
				...
				#region 讀取問卷主題資料
				SqlString = "Select Top 1 h.bh_title, h.bh_topic, h.is_check";
				SqlString += " , IsNull((Select Count(*) From Bt_Item b Where b.bh_sid = @bh_sid), 0) as item_num";
				SqlString += " From Bt_Head h Where h.bh_sid=@bh_sid;";
	...
	protected void lk_ok_Click(object sender, EventArgs e)
	{
		...
		if (mErr == "")
			ClientScript.RegisterStartupScript(this.GetType(), "ClientScript", "parent.show_win(\"A00411.aspx?sid=" + lb_bh_sid.Text + "\", -1, -1);", true);
		else
			ClientScript.RegisterStartupScript(this.GetType(), "ClientScript", "alert(\"" + mErr + "\");", true);
	}
}
