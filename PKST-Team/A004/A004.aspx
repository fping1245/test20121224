<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A004.aspx.cs" Inherits="_A004" %>
...
<script language="javascript" type="text/javascript">
	...
	function madd(msid)
	{
		show_win("A0041.aspx?sid=" + msid, -1, -1);
	}
</script>
</head>
<body>
	...
	<center>
	<p class="text18pt" style="margin:10pt 0pt 10pt 0pt; font-family:標楷體; text-align:center">票選活動(選擇)</p>
	<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">票選問卷清單</p>
	<p class="text9pt" style="margin:0pt 0pt 5pt 0pt; text-align:center">(僅顯示納入排程，允許填寫的問卷)</p>
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="功能" ShowHeader="False">
				<ItemTemplate>
					<a href="javascript:madd(<%# Eval("bh_sid") %>)" class="abtn" title="參加票選活動">&nbsp;我要參加&nbsp;</a>&nbsp;
				</ItemTemplate>
	...
	<asp:ObjectDataSource ID="ods_Bt_Head" runat="server" EnablePaging="True" 
		...
		<SelectParameters>
			...
			<asp:Parameter Name="now_use" Type="String" DefaultValue="1" />
			<asp:Parameter Name="is_show" Type="String" DefaultValue="1" />
		</SelectParameters>
