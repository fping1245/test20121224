<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A00411.aspx.cs" Inherits="_A00411" %>
...
<body>
	...
	<div>
	<center>
	<p class="text18pt" style="margin:10pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">票選活動(選擇)</p>
	...
	<tr><td style="text-align:center; width:70pt; background-color:#99CCFF; color:#FFFFFF">票選方式</td>
		<td style="text-align:left; width:230pt"><asp:Label ID="lb_is_check" runat="server"></asp:Label>&nbsp;</td>
		<td style="text-align:center; width:70pt; background-color:#99CCFF; color:#FFFFFF">主題編號</td>
	...
	<p class="text12pt" style="margin:5pt 0pt 2pt 0pt; text-align:center">票選項目統計圖</p>
	...
	<p style="margin:10pt 0pt 5pt 0pt; text-align:center"><a href="javascript:parent.close_all()" class="abtn">&nbsp;回問卷選擇頁&nbsp;</a></p>&nbsp;
	</center>
