<%@ WebHandler Language="C#" Class="_3001621" %>
//---------------------------------------------------------------------------- 
//程式功能	相簿管理 > 縮圖顯示 > 全圖顯示 > 產生圖形
//備註說明
//---------------------------------------------------------------------------- 
using System;
...
public class _3001621 : IHttpHandler, IRequiresSessionState
{
			...
			if (int.TryParse(context.Request["ac_sid"], out ac_sid))
			{
				...
				using (SqlConnection Sql_Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["AppSysConnectionString"].ConnectionString))
				{
					...
					using (SqlCommand Sql_Command = new SqlCommand())
					{
						...
						SqlString = "Select Top 1 ac_content, ac_type From Al_Content Where ac_sid = @ac_sid";
						...
						if (Sql_Reader.Read())
						{
							byte[] ac_content = (byte[])Sql_Reader["ac_content"];

							context.Response.Clear();
							context.Response.Charset = "utf-8";

							// 設定輸出格式
							context.Response.ContentType = Sql_Reader["ac_type"].ToString();
							context.Response.BinaryWrite(ac_content);
