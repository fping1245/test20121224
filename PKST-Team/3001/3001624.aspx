<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3001624.aspx.cs" Inherits="_3001624" %>
...
<body>
	...
	<tr><td align="center">
			<p style="margin:10px 0px 5px 0px; font-size:11pt; font-weight:bold; color:Green">相片說明修改</p>
			...
			<tr><td style="width:60" align="center">備註說明</td>
				<td align="left"><asp:TextBox ID="tb_ac_desc" runat="server" Rows="4" TextMode="MultiLine" Width="100%"></asp:TextBox></td>
			</tr>
			...
			<asp:Button ID="bn_ok" runat="server" Height="22pt" Text="確定" 
					ToolTip="按下確定之後，檔案就不見了，請三思喔！" onclick="bn_ok_Click" />&nbsp;
