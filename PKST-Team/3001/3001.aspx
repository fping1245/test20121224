<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3001.aspx.cs" Inherits="_3001" %>
...
<script language="javascript" type="text/javascript">
	...
	function tree_reload(sid) {
		...
		if (ifobj != null)
			ifobj.src = "30011.aspx?al_sid=" + sid + "&ti=" + Math.floor(Math.random() * 100);
		// 加入亂數，以避開瀏覽器 Cache 的問題
	}
	...
	function show_slide(row) {
		...
		mhref = "30017.aspx?al_sid=<%=lb_al_sid.Text%>&rownum=" + row + "&imgw=" + (window.screen.availWidth - 10).toString();
...
<body>
	...
	<center>
	<p align="center" class="text18pt" style="margin:10pt 0pt 10pt 0pt; font-family:標楷體;">相簿管理(使用資料庫儲存圖檔)</p>
	<hr style="width:99%" />
	...
	<tr align="left">
		...
		<td class="text11pt">幻燈片換景效果：<span id="effect_name" class="text11pt" style="color:#00008B; font-weight:bold">隨機</span></td>
	</tr>
	</table>
	<hr style="width:99%" />
	<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin:0pt 0pt 0pt 0pt">
	<tr><td align="left" class="text11pt">
			<asp:UpdatePanel ID="up_button" runat="server" RenderMode="Inline">
				<ContentTemplate>
					...
					<input type="button" value="上傳檔案" style="height:22pt" onclick="show_win('30015.aspx?al_sid=<%=lb_al_sid.Text%>', 260, 215)" />
	...
	<tr><td align="center" class="text9pt"><br />
			<input type="button" value="建子目錄" onclick="close_div('div_dir');show_win('30012.aspx?al_sid=<%=lb_al_sid.Text%>', 240, 220)" style="height:22pt" /><br /><br />
			<input type="button" value="刪除目錄" onclick="close_div('div_dir');show_win('30013.aspx?al_sid=<%=lb_al_sid.Text%>', 240, 148)" style="height:22pt" /><br /><br />
			<input type="button" value="目錄更名" onclick="close_div('div_dir');show_win('30014.aspx?al_sid=<%=lb_al_sid.Text%>', 240, 350)" style="height:22pt" /><br /><br />
	...
	<tr><td style="width:250px" valign="top" align="left">
			<iframe id="if_tree" src="30011.aspx?al_sid=<%=lb_al_sid.Text%>" frameborder="0" style="width:250px; height:522px"></iframe>
		</td>
		<td valign="middle" align="center" style="width:100%">
			<iframe id="if_thumb" src="30016.aspx?al_sid=<%=lb_al_sid.Text%>" frameborder="0" style="width:660px"></iframe>
		</td>
	</tr>
	</table>
	</center>
