...
<body>
	...
	<p align="center" class="text14pt" style="margin:10pt 0pt 0pt 0pt; font-family:標楷體;">驗證最高層網域 (Top Level Domain)</p>
	<table width="98%" border="1" cellpadding="4" cellspacing="0" class="text9pt">
	<tr><td rowspan="4" style="width:120pt">驗證最高層網域 (Top Level Domain)</td>
	...
	<tr><td><asp:Button ID="bn_TopLevelDomain" runat="server" Text="輸出" onclick="bn_TopLevelDomain_Click" /></td>
