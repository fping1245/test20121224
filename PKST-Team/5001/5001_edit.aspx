<%@ Page Language="C#" AutoEventWireup="true" CodeFile="5001_edit.aspx.cs" Inherits="_5001_edit" %>
...
<div>
	...
	<p align="center" class="text16pt" style="margin:0pt 0pt 5pt 0pt; font-family:標楷體;">修改資料</p>
	<center>
	<table cellspacing="0" cellpadding="4" rules="all" border="1" style="background-color:White;border-color:#003366;border-width:1px;border-style:Double;width:580pt;border-collapse:collapse;">
		<tr align="left" style="background-color:#99FF99;height:18pt">
			...
			<td align="left" style="background-color:#F7F7DE; color:Red; font-weight:bold;">&nbsp;
				<asp:Label ID="lb_cg_sid" runat="server"></asp:Label>
			</td>
			<td style="width:90pt" align="center">顯示順序</td>
			<td style="background-color:#F7F7DE">
				<asp:TextBox ID="tb_cg_sort" Width="98%" runat="server" MaxLength="5" ToolTip="「顯示順序」請輸入 0~32767 的數字，存檔後會自動依數字大小重新編排"></asp:TextBox>
			</td>
		</tr>
		<tr align="left" style="background-color:#99FF99;height:18pt">
		...
		<tr align="left" style="background-color:#99FF99;height:18pt">
			...
			<td style="background-color:#F7F7DE" colspan="3">
				<asp:TextBox ID="tb_cg_desc" runat="server" Width="98%" MaxLength="500" TextMode="MultiLine" ToolTip="「備註說明」最多500個字" Columns="5"></asp:TextBox>
			</td>
		</tr>
	</table>
	<table cellspacing="0" cellpadding="2" rules="all" border="0" style="width:580pt;">
	<tr><td align="left" style="width:10pt">※</td>
		<td align="left">「顯示順序」只要填你想移動到那一筆前面的順序數字即可，填入後系統會自動依序重新編排數字。</td>
	</tr>
	</table>
