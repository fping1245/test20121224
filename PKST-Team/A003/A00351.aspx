<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A00351.aspx.cs" Inherits="_A00351" %>
...
<body>
	...
	<tr><td align="center">
			<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體">新增問卷項目</p>
			...
			<tr><td style="text-align:center; width:80px; background-color:#99CCFF; color:#FFFFFF">顯示順序</td>
				<td align="left"><asp:TextBox ID="tb_bi_sort" runat="server" Text="255" Width="60px"></asp:TextBox>&nbsp;(0 ~ 255 的數字)</td>
			</tr>
