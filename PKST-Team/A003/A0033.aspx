<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A0033.aspx.cs" Inherits="_A0033" %>
...
<body>
	...
	<tr><td align="center">
		<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體">修改票選問卷</p>
		<table border="1" cellpadding="4" cellspacing="0" style="width:660px; background-color:#F7F7DE">
		<tr><td style="text-align:center; width:80px; background-color:#99CCFF; color:#FFFFFF">主題編號</td>
			<td align="left"><asp:Label ID="lb_bh_sid" runat="server"></asp:Label>&nbsp;</td>
		</tr>
