<%@ Page Language="C#" AutoEventWireup="true" CodeFile="F001.aspx.cs" Inherits="_F001" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=UTF8" />
<link href="../css/css.css" rel="stylesheet" type="text/css" />
<title>產生 Word 檔案</title>
<script language="javascript" type="text/javascript">
	...
	function mprn(msid)
	{
		...
		update.location.href = "F0011.ashx?sid=" + msid + "&timestamp=" + timestamp;
	}
</script>
</head>
<body>
	...
	<div>
	<center>
	<p class="text18pt" style="margin:10pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">產生 Word 檔案</p>
	<p class="text14pt" style="margin:5pt 0pt 5pt 0pt; font-family:標楷體; text-align:center">▁▂▃▄▅▆▇&nbsp;以線上考試空白試卷為例&nbsp;▇▆▅▄▃▂▁</p>
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="功能" ShowHeader="False">
				<ItemTemplate>
					<a href="javascript:mprn(<%# Eval("tp_sid") %>)" class="abtn" title="產生 Word 格式未填答案的試卷">&nbsp;產生試卷&nbsp;</a>&nbsp;
				</ItemTemplate>
