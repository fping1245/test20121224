...
<body>
	...
	<p align="center" class="text14pt" style="margin:10pt 0pt 0pt 0pt; font-family:標楷體;">Quoted Printable編碼/解碼</p>
	<table width="98%" border="1" cellpadding="4" cellspacing="0" class="text9pt">
	<tr><td rowspan="7" style="width:120pt">Quoted Printable 編碼/解碼</td>
	...
	<tr><td align="center">編碼斷行</td>
		<td align="left"><asp:TextBox ID="tb_linebreaks" runat="server" Text="1" Width="20px"></asp:TextBox>&nbsp;(設定編碼時每75字是否要斷行，0:不斷行 1:斷行。編碼時才有作用)</td>
	</tr>
