<%@ Page Language="C#" AutoEventWireup="true" CodeFile="700211.aspx.cs" Inherits="_700211" %>
...
<body style="margin:5px 0px 5px 0px" onkeydown="if(!(window.event.shiftKey) && window.event.keyCode==13) {send_msg();}">
	...
	<tr><td align="left">&nbsp;<asp:Button ID="bn_smsg" runat="server" Text="傳送訊息" Height="24px" onclick="bn_smsg_Click" /></td>
		...
		<td align="right">
			<asp:FileUpload ID="fu_file" runat="server" Height="24px" ToolTip="單一檔案上傳最大值為 4096K bytes" />
			<asp:Button ID="bn_sfile" runat="server" Text="上傳檔案" Height="24px" onclick="bn_sfile_Click" />&nbsp;&nbsp;
		</td>
	</tr>
	</table>
	</center>
